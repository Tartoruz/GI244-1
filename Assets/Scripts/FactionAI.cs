...
public class FactionAI : MonoBehaviour
{
    ...
    private void Check()
    {
        ...
        WorkerFindResource(ResourceSource.ResourceType.Wood,3);
        WorkerFindResource(ResourceSource.ResourceType.Food,2);
    }
    ...
    private void WorkerFindResource(ResourceSource.ResourceType rType, int n)
    {
